		...
		<div class="formcontainer">
			<div class="container">
				...
				<label for="psw"><strong>Password</strong></label> <input
					type="password" placeholder="Enter Password Minimum 8 characters" name="psw" required autocomplete="off">
				<label for="psw"><strong>Employee Id</strong></label> <input
					type="text" placeholder="Enter Id" name="id" required autocomplete="off"> 
			</div>
